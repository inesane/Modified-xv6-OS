...
int main(int argc, char *argv[])
{
  ...
  16:	8b 0d 10 0b 00 00    	mov    0xb10,%ecx
  ...
  2d:	39 1d 10 0b 00 00    	cmp    %ebx,0xb10
  ...
  for (j = 0; j < number_of_processes; j++)
  53:	39 1d 10 0b 00 00    	cmp    %ebx,0xb10
  ...
  5b:	83 3d 10 0b 00 00 fc 	cmpl   $0xfffffffc,0xb10
  ...
  for (j = 0; j < number_of_processes+5; j++)
  75:	a1 10 0b 00 00       	mov    0xb10,%eax
  ...
  93:	3b 05 10 0b 00 00    	cmp    0xb10,%eax
  ...
  bc:	3b 05 10 0b 00 00    	cmp    0xb10,%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 5b 08 00 00       	mov    $0x85b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 14 0b 00 00       	mov    0xb14,%eax
{
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 14 0b 00 00       	mov    %eax,0xb14
}
