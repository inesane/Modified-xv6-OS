...
main(int argc, char *argv[])
{
  ...
  2b:	e8 cb 02 00 00       	call   2fb <exec>
        exit();
  30:	e8 8e 02 00 00       	call   2c3 <exit>
    }
    else
    {
        waitx(&wtime, &rtime);
  35:	50                   	push   %eax
  36:	50                   	push   %eax
  37:	8d 45 f4             	lea    -0xc(%ebp),%eax
  3a:	50                   	push   %eax
  3b:	8d 45 f0             	lea    -0x10(%ebp),%eax
  3e:	50                   	push   %eax
  3f:	e8 1f 03 00 00       	call   363 <waitx>
        printf(1, "Wait time = %d\nRun Time = %d\n", wtime, rtime);
  44:	ff 75 f4             	pushl  -0xc(%ebp)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb b6 07 00 00       	mov    $0x7b6,%ebx
        while(*s != 0){
